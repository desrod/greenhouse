...
REGIONS = {
    "americas": [
        ...
        "Home based - Americas, Curitiba, Paraná, Brazil",
        "Home based - Americas, Lima, Lima Province, Peru",
        ...
        "Home based - Americas, Santiago, Rio Grande do Sul, Brazil",
    ...
    "nycmetro": [
        ...
        "Home based - Americas, Union City, New Jersey, United States",
    ...
    "brasil": [
        ...
        "Home based - Americas, Belo Horizonte, Minas Gerais, Brazil",
        "Home based - Americas, Porto Alegre, Rio Grande do Sul, Brazil",
        "Home based - Americas, Salvador, Bahia, Brazil",
        "Home based - Americas, Recife, Pernambuco, Brazil",
        "Home based - Americas, Fortaleza, Ceará, Brazil",
    ],
    "emea": [
